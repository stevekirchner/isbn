...
var Table = (function(){
	...
	function removeClass(o,name) {
		var c = o.className || "";
		// This makes sure that the proper number of spaces are deleted when removing a class...
		o.className = c.replace(new RegExp("( (?="+name+" ))? ?"+name+" ?"),"$1");
	};
	...
	*/
	 ...
	 */
	/* The user will call Table.auto manually. */
	/*
